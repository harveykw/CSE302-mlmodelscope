...
class Onnx_AlexNet:
    def __init__(self):
        ...
        self.session = ort.InferenceSession('./mlmodelscope/onnxruntime_agent/model_files/torchvision_alexnet.onnx', sess_options)
        self.input_name = self.session.get_inputs()[0].name
        self.output_name = self.session.get_outputs()[0].name
        self.model = onnx.load('./mlmodelscope/onnxruntime_agent/model_files/torchvision_alexnet.onnx')
