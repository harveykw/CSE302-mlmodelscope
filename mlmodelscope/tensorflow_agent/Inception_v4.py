...
class Tensorflow_ResNet():
	def __init__(self):
		self.model = tf.keras.Sequential([hub.KerasLayer("https://tfhub.dev/metmuseum/vision/classifier/imet_attributes_V1/1")])
		self.model.build([None, 299, 299, 3])  # Batch input shape.
