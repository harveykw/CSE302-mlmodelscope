...
class Tensorflow_ResNet():
	def __init__(self): 
		self.model = tf.keras.Sequential([hub.KerasLayer("https://tfhub.dev/google/imagenet/mobilenet_v1_050_192/quantops/classification/3")])
		self.model.build([None, 192, 192, 3])
