...
class Tensorflow_ResNet():
	def __init__(self): 
		self.model = tf.keras.Sequential([hub.KerasLayer("https://tfhub.dev/google/imagenet/mobilenet_v1_100_160/quantops/classification/3")])
		self.model.build([None, 160, 160, 3])
